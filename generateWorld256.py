...
""" Generates a csv file, so that each row contains a random bounding box, and width and height (both set to 256). These
parameters are used in the WMS GetMap request.

Usage: python generateWorld256.py <csv file to be generated> <number of rows of csv file>
