...
""" Generates a csv file, so that each row contains a random bounding box, and width and height values equal to 1024. These
parameters are used in the WMS GetMap request. The bounding boxes refer to areas in NYC.

Usage: python generateNYC1024.py <csv file to be generated> <number of rows of csv file>
...
with open(sys.argv[1], 'wb') as csvFile:
    ...
    for i in range(0, numberOfRows):
        ...
        row = (tLon1, tLat1, tLon2, tLat2, 1024, 1024)
